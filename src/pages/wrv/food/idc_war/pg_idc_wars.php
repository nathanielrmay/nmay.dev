...
class pg_idc_wars extends aIdcWarPage {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_war'])) {
    ...
    if ($warPk) {
        ...
        header('Location: /wrv/food/idc_war/pg_idc_wars.php?war=' . $warPk . '&saved=true');
        exit;
    } else {
...
<div style="padding: 20px; max-width: 800px;">
    ...
    <div style="margin-bottom: 20px;">
        ...
        <select id="war-selector" onchange="if(this.value) { window.location.href='/wrv/food/idc_war/pg_idc_wars.php?war=' + this.value; } else { window.location.href='/wrv/food/idc_war/pg_idc_wars.php'; }"
    ...
    <?php if ($selectedWar): ?>
        <div style="margin-bottom: 20px;">
            <a href="/wrv/food/idc_war/pg_vote.php?war=<?= $selectedWar['pk'] ?>" target="_blank"
    ...
    <form method="POST" action="/wrv/food/idc_war/pg_idc_wars.php" id="war-form">
    ...
    <form method="POST" action="/wrv/food/idc_war/pg_idc_wars.php" id="war-submit-form">
        ...
        <div style="display: flex; gap: 15px; justify-content: flex-end; margin-top: 30px;">
            <a href="/wrv/food/idc_war/pg_idc_wars.php" 
